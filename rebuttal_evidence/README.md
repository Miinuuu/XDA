...
| §3 BF16/FP8 generalization (A-Q1) | `bf16/exp_bf16_preliminary.py`, `bf16/bf16_preliminary_out.log`, `bf16/exp_bf16_floor.py`, `bf16/bf16_floor_out.log` | W=512 covers all 9 functions; nonzero K on 19–34 octaves for the activation/exp-family functions (the 34 maximum is exp); rsqrt 36/36 and reciprocal 32/32 octaves; **XDA-BF16 within 1.5–3.2× of the BF16 round-to-nearest floor** across all 9 functions (near-optimal) |
