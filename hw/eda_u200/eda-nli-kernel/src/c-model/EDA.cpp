...
extern "C" {
void EDA(int size, // Size in integer
...
#pragma HLS PIPELINE II = 1
	    ...
	    std::cout << "EDA: vout_buffer[j] = " << vout_buffer[j] << std::endl;
	    std::cout << "EDA: j =" << j << " vout_buffer[j]: " << vout_buffer[j] << std::endl; 
        }
...
#pragma HLS PIPELINE II = 1
	    ...
	    std::cout << "EDA: vout_buffer[i] = " << vout_buffer[i] << std::endl;
	    //d::cout << "EDA: j =" << j << " vout_buffer[j]: " << vout_buffer[j] << std::endl; 
        }
